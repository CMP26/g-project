...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        glm::mat4 v_p = camera->getProjectionMatrix(size) * camera->getViewMatrix();
        ...
        for(auto& entity : world.getEntities()){
            ...
            glm::mat4 matrix = v_p * entity->getLocalToWorldMatrix();
            if(meshRenderer->material && meshRenderer->material->shader) meshRenderer->material->shader->set("transform", matrix);
